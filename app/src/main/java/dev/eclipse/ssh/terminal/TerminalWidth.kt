...
private val ZERO_WIDTH_RANGES = listOf(
    0x00000..0x00000,  // NUL, which the width function answers before it ever reaches a table
    0x0061C..0x0061C,  // ARABIC LETTER MARK, the Arabic counterpart of the directional marks below
    0x00897..0x00897,  // ARABIC PEPET, zero-width to the reference and unassigned in Unicode 15.1
    ...
    0x03164..0x03164,  // HANGUL FILLER, a choseong filler that takes no column
    ...
    0x0FEFF..0x0FEFF,  // a byte-order mark
    ...
    0x10EFC..0x10EFC,  // and this Arabic mark with them
    0x113BB..0x113C0,  // the Grantha and Tulu-Tigalari signs, and the rest of the supplementary marks:
    0x113CE..0x113CE,  // each of these is zero-width to the reference while Unicode 15.1 still calls it
    0x113D0..0x113D0,  // unassigned, which is exactly the discrepancy that makes this list explicit
    0x113D2..0x113D2,  // rather than leaving the answer to the platform's own tables
    0x113E1..0x113E2,
    ...
    0xE0001..0xE0001,  // a language tag, and the tag characters that carry it
